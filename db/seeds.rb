...
album1 = Album.new({'title' => 'Revolver','artist' => @artist1.id,'genre' => '60s Rock','quantity' => 5, 'buy' => 7.57, 'sell' => 9.99, 'url' => 'http://www.thebeatles.com/sites/default/files/styles/tile_1_column_x2/public/tile/image/Revolver_3.jpg?itok=reySQMFx' })
album1.save()
album2 = Album.new({'title' => 'Sgt.Peppers Lonely Hearts Club Band','artist' => @artist1.id,'genre' => '60s Rock','quantity' => 10, 'buy' => 9.38, 'sell' => 12.99, 'url' => 'http://www.thebeatles.com/sites/default/files/styles/tile_1_column_x2/public/tile/image/Revolver_3.jpg?itok=reySQMFx' })
album2.save()
